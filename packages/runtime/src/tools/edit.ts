...
- To create a new file when explicitly required, set old_string to an empty string and new_string to the complete file content. This create mode fails if the file already exists.
