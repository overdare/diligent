...
### 2. Update backlog tracking — steering queue is done

**What**: Mark "Add steering queue to agent loop" as done in backlog tracking (commit a848844 implements it fully).
