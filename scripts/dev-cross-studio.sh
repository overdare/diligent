...
EXPLICIT_CODEX_BIN="${DILIGENT_CODEX_BIN:-}"
...
DILIGENT_CODEX_BIN="${EXPLICIT_CODEX_BIN:-${DILIGENT_CODEX_BIN:-}}"
...
if [ -n "$DILIGENT_CODEX_BIN" ]; then
  echo "> Codex executable: ${DILIGENT_CODEX_BIN}"
else
  echo "> Codex executable: codex (PATH)"
fi
