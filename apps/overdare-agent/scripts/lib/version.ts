...
const TAURI_CONF_PATH = join(ROOT, "apps/overdare-agent/src-tauri/tauri.conf.json");
const TAURI_TEMP_CONFIG_DIR = join(ROOT, "apps/overdare-agent/src-tauri/.diligent-packaging");
