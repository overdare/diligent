...
//
// OVERDARE launcher/runtime instances auto-discover scoped plugins by scanning ~/.overdare/plugins/@<scope>/<name>.
...
const OVERDARE_CLI_DIR = join(import.meta.dir, "..");
const PLUGINS_DIR = join(OVERDARE_CLI_DIR, "plugins");
...
function deployPlugin(meta: PluginMeta): void {
  ...
  // Deploy path: ~/.overdare/plugins/@overdare/plugin-studiorpc/
