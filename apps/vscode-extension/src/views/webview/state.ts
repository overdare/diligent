...
import type { AgentEvent, ConversationLiveState, ThreadReadResponse } from "@diligent/protocol";
import { applyAgentEvents, createInitialConversationLiveState } from "@diligent/protocol";
